...
//							{ name: "Gabriele Bulfon", email: "gabriele.bulfon@sonicle.com", total: 98 }
					...
					columns: [
						{ 
							dataIndex: 'name', flex: 1, tdCls: 'wt-color-hyperlink wtmail-smartsearch-name-column',
					...
					items: [
						{
							...
							columns: [
								{ dataIndex: 'subject', flex: 1, tdCls: 'wt-color-hyperlink wtmail-smartsearch-name-column' },
