...
Ext.define('Sonicle.webtop.mail.model.UserOptions', {
	...
	fields: [
		...
		WTF.roField('permDomainMailcardManage', 'boolean'),
		WTF.roField('imapBackend', 'string'),
		...
		WTF.field('seenMode', 'string', false),
		...
		*/
		...
		WTF.field('folderArchive', 'string', true),
		...
		WTF.field('autoAddContact', 'boolean', false),
		...
		WTF.field('todayRowColorLight', 'string', true),
		WTF.field('todayRowColorDark', 'string', true),	
