...
import com.sonicle.webtop.mail.swagger.v1.api.MeUserSettingApi;
 ...
 * @author gbulfon
 */
public class MeUserSetting extends MeUserSettingApi {
	private static final Logger logger = LoggerFactory.getLogger(MeUserSetting.class);
	@Context private HttpHeaders httpHeaders;

	@Override
	public Response getUserSetting(String key) {
		UserProfileId targetPid = RunContext.getRunProfileId();
		MailManager mmgr = MailRestApiUtils.getMailManager(targetPid, httpHeaders);
		String value = mmgr.getMailUserSettings().getString(key, "");
		return respOk(value);
	}
